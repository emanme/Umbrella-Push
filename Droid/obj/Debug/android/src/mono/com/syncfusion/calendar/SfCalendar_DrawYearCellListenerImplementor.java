...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Calendar.SfCalendar+IDrawYearCellListenerImplementor, Syncfusion.SfCalendar.Android", SfCalendar_DrawYearCellListenerImplementor.class, __md_methods);
	}
	...
	public SfCalendar_DrawYearCellListenerImplementor ()
	{
		...
		if (getClass () == SfCalendar_DrawYearCellListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Calendar.SfCalendar+IDrawYearCellListenerImplementor, Syncfusion.SfCalendar.Android", "", this, new java.lang.Object[] {  });
	}
