...
namespace Umbrella.iOS.Dependencies
{
    public class TopupPaymentService : ITopupPaymentService
    {
        ...
        private readonly string _stripeSecretTestkey = "sk_test_E01Kh96YOzRtkhD5wItn8CDd";
        ...
        public async Task<Dictionary<bool, string>> ProcessCustomerCard(Models.Card card, int amount, string email)
        {
            ...
            if (!string.IsNullOrEmpty(customerId))
            {
                ...
                StripeConfiguration.SetApiKey("sk_test_E01Kh96YOzRtkhD5wItn8CDd");
        ...
        public async Task<List<RetrievedCard>> GetAllCurrentCards(string email)
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer sk_test_E01Kh96YOzRtkhD5wItn8CDd");
