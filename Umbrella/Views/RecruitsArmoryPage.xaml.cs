...
{
	public partial class RecruitsArmoryPage : ContentPage
	{
        ...
        {
            Editor.Focus();
            if (Editor.Text == "What have you told them so far? What can you tell us that will help us bring them on board?")
            {
                Editor.Text = "";
        ...
        private void EditorUnfocused(object sender, EventArgs e)
        {
            ...
            if (Editor.Text == "")
            {
                Editor.Text = "What have you told them so far? What can you tell us that will help us bring them on board?";
