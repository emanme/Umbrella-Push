...
{
	public partial class ComradesArmoryPage : ContentPage
	{
        ...
        {
            Editor.Focus();
            if (Editor.Text == "What have you told them so far? What was most interesting for them about the Umbrella Army?")
            {
                Editor.Text = "";
        ...
        private void EditorUnfocused(object sender, EventArgs e)
        {
            ...
            if (Editor.Text == "")
            {
                Editor.Text = "What have you told them so far? What was most interesting for them about the Umbrella Army?";
        ...
        private async void ReferNowClicked(object sender, EventArgs e)
        {
            ...
            if (EmailEntry.TextColor == Color.Red)
            {
                ...
                string.IsNullOrEmpty(PhoneNumberEntry.Text) || string.IsNullOrEmpty(MobileNumberEntry.Text) || string.IsNullOrEmpty(Editor.Text) || string.IsNullOrEmpty(Dropdown.Label)
                     || Editor.Text == "What have you told them so far? What was most interesting for them about the Umbrella Army?" || Dropdown.Label == "Select...")
            {
