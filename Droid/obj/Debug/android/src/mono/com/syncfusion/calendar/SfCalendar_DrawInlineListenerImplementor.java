...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Calendar.SfCalendar+IDrawInlineListenerImplementor, Syncfusion.SfCalendar.Android", SfCalendar_DrawInlineListenerImplementor.class, __md_methods);
	}


	public SfCalendar_DrawInlineListenerImplementor ()
	{
		super ();
		if (getClass () == SfCalendar_DrawInlineListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Calendar.SfCalendar+IDrawInlineListenerImplementor, Syncfusion.SfCalendar.Android", "", this, new java.lang.Object[] {  });
	}
