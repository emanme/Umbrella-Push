...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Mapbox.Mapboxsdk.Maps.MapboxMap+IOnCameraMoveListenerImplementor, Naxam.Mapbox.Droid", MapboxMap_OnCameraMoveListenerImplementor.class, __md_methods);
	}
	...
	public MapboxMap_OnCameraMoveListenerImplementor ()
	{
		...
		if (getClass () == MapboxMap_OnCameraMoveListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Mapbox.Mapboxsdk.Maps.MapboxMap+IOnCameraMoveListenerImplementor, Naxam.Mapbox.Droid", "", this, new java.lang.Object[] {  });
	}
