...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Calendar.SfCalendar+IDrawMonthCellListenerImplementor, Syncfusion.SfCalendar.Android", SfCalendar_DrawMonthCellListenerImplementor.class, __md_methods);
	}


	public SfCalendar_DrawMonthCellListenerImplementor ()
	{
		super ();
		if (getClass () == SfCalendar_DrawMonthCellListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Calendar.SfCalendar+IDrawMonthCellListenerImplementor, Syncfusion.SfCalendar.Android", "", this, new java.lang.Object[] {  });
	}
